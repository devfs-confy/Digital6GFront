<template>
  <div
    class="relative min-h-screen w-full bg-d6g-dark flex items-center justify-center px-4 py-8 overflow-hidden"
    style="font-family:'Plus Jakarta Sans',sans-serif"
  >
    <!-- Blobs -->
    <div
      class="fixed rounded-full pointer-events-none z-0 blur-[90px] w-[520px] h-[520px] -top-[160px] -left-[160px]"
    ...
    <!-- Card -->
    <div
      class="relative z-10 flex w-[92%] max-w-[860px] rounded-[28px] overflow-hidden"
    ...
    >
      <!-- Brand side (desktop) -->
      <div
        class="hidden md:flex flex-col justify-between w-[44%] flex-shrink-0 px-9 py-11"
        style="background:linear-gradient(155deg,#1b4e32 0%,#0D291C 100%)"
      >
        <div>
          <span class="block text-[0.67rem] font-bold tracking-[0.13em] uppercase mb-3" style="color:rgba(127,211,68,0.7)">
            Recuperación
          </span>
      ...
      <!-- Form side -->
      <div class="flex-1 bg-white flex flex-col items-center justify-center px-11 py-[52px] max-md:px-7 max-md:py-9 relative overflow-hidden min-h-[540px]">
        <!-- Top accent -->
        <div
              ...
              <div class="flex flex-col gap-[18px]">
                ...
                <div class="flex flex-col gap-1.5">
                  ...
                  <div class="relative flex items-center">
                    <svg
                      class="absolute left-3 w-[15px] h-[15px] pointer-events-none transition-colors"
                      :class="errorMsg ? 'text-red-300' : 'text-slate-300'"
                ...
                <Transition name="err-slide">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#dc2626" viewBox="0 0 24 24" class="shrink-0">
                ...
                <div class="flex items-center justify-between text-[0.82rem]">
                  <router-link to="/login" class="text-slate-400 font-medium hover:text-d6g-gray no-underline transition-colors">
                    ← Volver al login
                  </router-link>
                  <button
                    type="button"
                ...
                >
                  <span v-if="loading" class="w-[15px] h-[15px] border-2 border-white/30 border-t-white rounded-full animate-spin shrink-0" />
                  <span>{{ loading ? 'Enviando...' : 'Enviar código' }}</span>
                  <svg v-if="!loading" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" class="btn-arrow">
            ...
            <div v-else-if="step === 2" key="step2">
              ...
              <div class="flex flex-col gap-5">
                ...
                <div class="flex items-center justify-center gap-1.5">
                  <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="shrink-0" :class="skippedSend ? 'text-d6g-green' : 'text-slate-400'">
                  ...
                  <span
                    v-else
                    class="text-[0.8rem] font-semibold transition-colors"
                ...
                <div class="flex gap-2 justify-center">
                  <input
                    ...
                    :class="
                      errorMsg && !otpDigits[i] ? 'border-red-300 bg-red-50/40'
            ...
            <div v-else-if="step === 3" key="step3">
              ...
              <div class="flex flex-col gap-[18px]">
                ...
                <div class="flex flex-col gap-1.5">
                  ...
                  <div class="relative flex items-center">
                    <svg class="absolute left-3 w-[15px] h-[15px] pointer-events-none text-slate-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    >
                      <svg v-if="!showNew" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="flex flex-col gap-1.5">
                  ...
                  <div class="relative flex items-center">
                    ...
                    <button
                      ...
                      class="absolute right-3 text-slate-400 hover:text-d6g-gray transition-colors bg-transparent border-none cursor-pointer p-0"
                    >
                      <svg v-if="!showConfirm" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/>
                      </svg>
                      <svg v-else xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/>
        ...
        <!-- Deco logo -->
        <img src="@/assets/img/confy-negro.png" alt="" class="absolute bottom-0 right-0 w-[72px] opacity-10 pointer-events-none" />
      </div>
    </div>
  </div>
</template>
...
/* Step transition */
.step-fade-enter-active { transition: opacity 0.22s ease, transform 0.22s ease; }
...
.err-slide-leave-active { transition: opacity 0.15s ease; }
.err-slide-enter-from  { opacity: 0; transform: translateY(-5px); }
